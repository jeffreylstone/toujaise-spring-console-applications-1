...
public class AffixRule {
	...
	public static final String AFFIX_NO_STRIPPING_CHARS = "0";
	
	public static final String AFFIX_NO_CONDITION = ".";
	
	
	private String strippingCharacters;
	...
	public AffixRule(String strippingCharacters, String affix, String condition) {
		super();
		
		this.setStrippingCharacters(strippingCharacters);
		this.setAffix(affix);
		this.setCondition(condition);
	}

	/**
	 * @param strippingCharacters the strippingCharacters to set
	 */
	public void setStrippingCharacters(String strippingCharacters) {
		if (AFFIX_NO_STRIPPING_CHARS.equals(strippingCharacters)) {
			this.strippingCharacters = "";
		}
		else {
	...
	public void setCondition(String condition) {
		...
		if (null != condition
				&& !(condition.equals(AFFIX_NO_CONDITION))) {
